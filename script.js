$(document).ready(function () {
    ...
    // Xử lý sự kiện khi nhấn nút trong modal
    ...
    // Xử lý sự kiện khi nhấn nút mixer
    ...
    $(".oven").droppable({
        drop: function (event, ui) {
            $('.stage3').fadeOut();
            fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png', 'Bake successful!', 'Yes! You are a master chef. The base is fully baked and looks super yummy. Now it's time to combine this base with lots of other ingredients like jam, marmalade, chocolate and more.');
        }
    });
    ...
    function add_candle() {
        let stages = $('.cakemake > div').length;
        let h = (stages / 2) * 41 + 22 + 'px';
